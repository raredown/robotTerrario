...
<%
    String subtitulo1="Consulta Histórico Procesos Expirados";
...
<TD class=Titulo vAlign=top align=middle background="images/fondocentro.gif">
    ...
    <form action="" method="post" name="theForm" class="texto2">
        ...
        </table> <!--Tabla de la cabecera donde están todos los filtros de la busqueda -->

    </form>

    <center><A HREF="javascript:Buscar()" onMouseOver="window.status='Realizar búsqueda';return true;" onMouseOut="window.status=' '"><img src="images/buscar.gif" width="107" height="28" onClick="" border="0"></a></center>
    <br>
    <%
