...
<%@ page
	import="java.io.*,es.portanode.util.ProcesosBean,java.util.Vector,es.portanode.ficheros.Excell,es.portanode.util.html.SesionConectada"%>
...
function Navegar(nPagina) {
    ...
    f.action = "PrevioConsultaHisProceso";
    f.submit();
}
...
<table width='100%' height='90%' border='0' cellpadding='0'
	...
	<TBODY>
		<TR>
			...
			<TD vAlign=top width="180" class="celdalineaderecha"><%@ include
				file="menu.jsp"%></TD>
			<!-- InstanceBeginEditable name="contenido" -->
			<TD class=Titulo vAlign=top align=middle
				background="images/fondocentro.gif"><br>

			<DIV align=left class="Titulo">&nbsp;&nbsp;&nbsp;<img
				src="images/flecha.gif" border="0" />Consulta Hist&oacute;rico
			Procesos</DIV>

			<form action="" method="post" name="theForm" class="texto2"><input
				type="hidden" name="Ordenar" value="<%=ordenar%>"> <input
				type="hidden" name="Total" value="<%=total%>"> <input
				type="hidden" name="Posicion" value="<%=pagina%>"> <input
				type="hidden" name="contiene" value="<%=contiene%>">
			...
			<table width="90%" border="0" align="center" cellspacing="4">
				...
				<tr>
					...
					<table width="100%">
						<tr>
							<td><label> <input type="radio" name="TipoConsulta"
								value="1" <%if (tipoConsulta.equals("1")) {%> checked <%}%>
								onClick="CambiarConsulta(this)"> <font class="texto2">Por
							Proceso</font></label></td>
						</tr>
						<tr>
							<td><label> <input type="radio" name="TipoConsulta"
								value="2" <%if (tipoConsulta.equals("2")) {%> checked <%}%>
								onClick="CambiarConsulta(this)"> <font class="texto2">Por
							Numeración</font></label></td>
						</tr>
						<tr>
							<td><label> <input type="radio" name="TipoConsulta"
								value="3" <%if (tipoConsulta.equals("3")) {%> checked <%}%>
								onClick="CambiarConsulta(this)"> <font class="texto2">Por
							Operador</font></label></td>
						</tr>
						<tr>
							<td><label> <input type="radio" name="TipoConsulta"
								value="4" <%if (tipoConsulta.equals("4")) {%> checked <%}%>
								onClick="CambiarConsulta(this)"> <font class="texto2">Por
							NIF/CIF</font></label></td>
						</tr>
						<tr>
							<td height="1" background="images/separador.gif"></td>
						</tr>
						<tr>
							...
							<table id='ComboRol'
								...
								style="display: none" <%}%>>
								<tr>
									<td><label><font class="texto2">Rol:
									&nbsp;&nbsp;</font></label></td>
									<td><select name="Rol" class="pie">
						...
						<tr>
							<td class="texto2" height="30">L&iacute;mite: &nbsp;&nbsp; <select
								name="Limite" class="pie">
					...
					<table width="100%" border="0">
						<tr>
							<td align="right" colspan="5"><A HREF="#"
								onClick="Navegar(<%=pagina%>);"
								onMouseOver="window.status='Recargar';return true;"
								onMouseOut="window.status=' '"><img
								src="images/recargar.gif" border="0" alt="Recargar"></A></td>
						</tr>
						<tr>
							<td>
							<table width="100%" border="0" id="TablaProceso"
								<%if (!tipoConsulta.equals("1")) {%> style="display: none" <%}%>
								cellpadding="4">
								<tr>
								...
								<tr>
									<td width="7%"><input type="radio" name="BuscaProceso"
										value="1" <%if (buscaProceso.equals("1")) {%> checked <%}%>
										onClick="CambiaBusquedaProceso(this)"></td>
									<td width="21%"><font class="texto2">Identificador
									:</font></td>
									<td width="26%"><input name="Identificador"
										value="<%=id_proceso%>" type="text" class="inputText"
								...
								<tr>
									<td width="7%"><input type="radio" name="BuscaProceso"
										<%if (buscaProceso.equals("2")) {%> checked <%}%>
										onClick="CambiaBusquedaProceso(this)" value="2"></td>
									<td><font class="texto2">Fecha Inicial :</font></td>
									<td><input name="FechaInicial" type="text"
										class="inputText" value="<%=fechaInicial%>" size="15"
										readonly="readonly" maxlength="10"> <a
										href="javascript:calendario1.popup();"><img id="cal1"
										src="images/calendar/cal.gif" width="16" height="16"
										border="0" alt="Calendario"
										<%if (buscaProceso.equals("1")) {%> style="display: none"
										<%}%>></a></td>
									<td><font class="texto2">Fecha Final :</font></td>
									<td><input name="FechaFinal" type="text"
										value="<%=fechaFinal%>" class="inputText" size="15"
										readonly="readonly" maxlength="10"> <a
										href="javascript:calendario2.popup();"><img id="cal2"
										src="images/calendar/cal.gif" width="16" height="16"
										border="0" alt="Calendario"
										<%if (buscaProceso.equals("1")) {%> style="display: none"
										<%}%>></a></td>
						...
						<tr>
							<td valign="top">
							<table width="100%" border="0" id="TablaNumeracion"
								<%if (!tipoConsulta.equals("2")) {%> style="display: none" <%}%>
								cellpadding="4">
								<tr>
									<td colspan="4" class="cabeceratabla" height="20">Numeraci&oacute;n&nbsp;</td>
								</tr>
								<tr>
									<td width="17%"><font class="texto2">Num Inicial :
									</font></td>
									<td width="30%"><input type="text" name="NumInicial"
										value="<%=numInicial%>" class="inputText" size="21"
										maxlength="15"></td>
									<td width="14%"><font class="texto2">Num Final : </font></td>
									<td width="31%"><input type="text" name="NumFinal"
										value="<%=numFinal%>" class="inputText" size="21"
										maxlength="15"></td>
								</tr>
							</table>
							</td>
						...
						<tr>
							<td>
							<table width="100%" border="0" id="TablaOperador"
								<%if (!tipoConsulta.equals("3")) {%> style="display: none" <%}%>
								cellpadding="4">
								<tr>
								...
								<tr>
									...
									<select name="CodigoOperador" class="pie">
										...
										%>
										<option value="<%=operador.getCodigo()%>"
											<%if (codigoOp.equals(operador.getCodigo())) {%> selected
											<%}%>><%=operador.getDescripcion()%></option>
										<%
											}
												}
										%>
								...
								<tr>
									...
									<table width="100%" border="0">
										<tr>
											<td align="right"><font class="texto2">Fecha
											Inicial:&nbsp;</font></td>
											<td align="left"><input name="FechaInicialOp"
												type="text" class="inputText" value="<%=fechaInicialOp%>"
												size="15" readonly="readonly" maxlength="10"> <a
												href="javascript:calendario3.popup();"><img id="cal3"
												src="images/calendar/cal.gif" width="16" height="16"
												border="0" alt="Calendario"></a></td>
										</tr>
										<tr>
											<td align="right"><font class="texto2">Fecha
											Final:&nbsp;</font></td>
											<td align="left"><input name="FechaFinalOp" type="text"
												value="<%=fechaFinalOp%>" class="inputText" size="15"
												readonly="readonly" maxlength="10"> <a
												href="javascript:calendario4.popup();"><img id="cal4"
												src="images/calendar/cal.gif" width="16" height="16"
												border="0" alt="Calendario"></a></td>
										</tr>
									</table>
									...
									<table width="100%" border="0">
										<tr>
											<td class="texto2"><input type="radio"
												name="RolOperador" value="D" <%if (rolOp.equals("D")) {%>
												checked <%}%>>Rol Donante</td>
										</tr>
										<tr>
											<td class="texto2"><input type="radio"
												name="RolOperador" value="R" <%if (rolOp.equals("R")) {%>
												checked <%}%>>Rol Receptor</td>
										</tr>
									</table>
									</td>
								</tr>
						...
						<tr>
							<td>
							<table width="100%" border="0" id="TablaNIF"
								<%if (!tipoConsulta.equals("4")) {%> style="display: none" <%}%>
								cellpadding="4">
								<tr>
									<td colspan="2" class="cabeceratabla" height="20">NIF/CIF&nbsp;</td>
								</tr>
								<tr>
									<td align="center"><font class="texto2">NIF/CIF:&nbsp;</font>
									<input name="NIF" type="text" class="inputText"
										value="<%=NIF%>" size="15" maxlength="15" /></td>
									<td align="center">
									<table width="100%" border="0">
										<tr>
											<td class="texto2"><input type="radio" name="RolNIF"
												value="D" <%if (rolNIF.equals("D")) {%> checked <%}%>>Rol
											Donante</td>
										</tr>
										<tr>
											<td class="texto2"><input type="radio" name="RolNIF"
												value="R" <%if (rolNIF.equals("R")) {%> checked <%}%>>Rol
											Receptor</td>
										</tr>
										<tr>
											<td class="texto2"><input type="radio" name="RolNIF"
												value="T" <%if (rolNIF.equals("T")) {%> checked <%}%>>Ambos
											Roles</td>
										</tr>
									</table>
									</td>
...
%>
			...
			<table width="98%" border="1" align="center" class="tablas">
				<tr>
					<td class="bgCabeceraFila"><img align="middle"
						onclick="javascript:desplegarTodos(this)" name="mostrarTodas"
						border="0" height="13" width="14" src="images/mostrar.gif" /> T</td>
					<td class="bgCabeceraFila" align="center"><img
						src="images/ascen.gif" border="0"
						alt="Ordenar por IdProceso Ascendente"
						onclick="ordenarDatos('IDA')"> &nbsp; &nbsp; Id. proceso
					&nbsp; &nbsp; <img src="images/descen.gif" border="0"
						alt="Ordenar por IdProceso Descendente"
						onclick="ordenarDatos('IDD')"></td>
					<td class="bgCabeceraFila" align="center"><img
						src="images/ascen.gif" border="0"
						alt="Ordenar por Fecha Ascendente" onclick="ordenarDatos('FA')">
					&nbsp; &nbsp; Fecha Inicio &nbsp; &nbsp; <img
						src="images/descen.gif" border="0"
						alt="Ordenar por Fecha Descendente" onclick="ordenarDatos('FD')">
					</td>
					<td class="bgCabeceraFila" align="center"><img
						src="images/ascen.gif" border="0"
						alt="Ordenar por Estado Ascendente" onclick="ordenarDatos('EA')">
					&nbsp; &nbsp; Estado &nbsp; &nbsp; <img src="images/descen.gif"
						border="0" alt="Ordenar por Estado Descendente"
						onclick="ordenarDatos('ED')"></td>
				</tr>
				...
				%>
				<tr>
					<form action="DetalleHisProceso"
						target="iframe<%=(pB.getID_PROCESO())%>" method=post
						name="form<%=indice%>"><INPUT TYPE="hidden"
						name="idProceso" value="<%=pB.getID_PROCESO()%>"> <INPUT
						TYPE="hidden" name="OperadorConexion" value="<%=imagen%>">
					<td class="<%=clase%>" align="center"><img align="middle"
						name="mostrar"
						onclick="mostrarOcultar(this,<%=indice%>,'<%=pB.getID_PROCESO() + "P"%>');"
						border="0" height="13" width="14" src="images/mostrar.gif"
						onMouseOver="mostrarAlt(this)" /></td>
				...
				<tr style="display: none" height="10"
					id="<%=pB.getID_PROCESO() + "P"%>">
					<td colspan='4'><iframe width="100%" height="100%"
						id="iframe<%=(pB.getID_PROCESO())%>"
						name="iframe<%=(pB.getID_PROCESO())%>" src="DetalleProcesoJSP"
