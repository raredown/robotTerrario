...
function Navegar(nPagina){
       ...
       f.action="PrevioConsultaHisMensaje";
       f.submit();
}
...
<%@ page import="java.io.*"%>
  ...
  <%
    String subtitulo1="Consulta del Histórico de Mensajes";
        ...
        document.write(tabla);
          ...
          <TR>
            ...
            <TD class=Titulo vAlign=top align=middle background="images/fondocentro.gif">
               <br>
               <DIV align=left class="Titulo">&nbsp;&nbsp;&nbsp;<img src="images/flecha.gif" border="0"/>Consulta del Histórico de Mensajes&nbsp;</DIV>

                 <div align="center"><center>
                   <br>
                   <br>
                    <table border="0">
                     <FORM METHOD=POST ACTION="PrevioConsultaHisMensaje" name="theForm">
                               ...
                               <table border="1" class="tablas">
                                   ...
                                   <tr>
                                       <form action="obtenDetalleHisMensaje" method=post name="form<%=indice%>">
                                           ...
                                           <TD class="<%=clase%>"><p>
                                               <a href="javascript:TodoOk(<%=indice%>)//'" onMouseOver="window.status='Ver Detalle';return true" onMouseOut="window.status=' '">
                                                   <img src="images/veer.gif" alt="Ver Detalle" border="0"></a></p></TD>
                                           <td class="<%=clase%>" align="center">
                                               <font class="texto2"><%=info.getIdProceso()%></font></td>
                                           <td class="<%=clase%>" align="center">
                                               <font class="texto2"><%=info.getTipoMensaje()%></font></td>
                                           <td class="<%=clase%>" align="center">
                                               <font class="texto2"><%=info.getInicioRango()%></font></td>
                                           <td class="<%=clase%>" align="center">
                                               <font class="texto2"><%=info.getFinalRango()%></font></td>
                                           <td class="<%=clase%>" align="center">
                                               <font class="texto2"><%=info.getFechaAlta()%></font></td>
                                           <td class="<%=clase%>" align="center">
                                               <font class="texto2"><%=info.getFechaRegistro()%></font></td>
                                       </form>
                                   </tr>
                                   <%}
                                   }
                         ...
                         <td align="center">
                            ...
                            <FORM METHOD=POST ACTION="MenuPrincipalJSP" name="fback">
                             ...
                             <form method=post action="GenerarExcelMensajes" name="excel">
                                 ...
                                 <input type="hidden" name="historico" value="SI">
