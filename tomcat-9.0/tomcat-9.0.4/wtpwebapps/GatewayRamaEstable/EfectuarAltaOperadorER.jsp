...
<%@ page import="java.sql.*" %>
 <%
     ...
     String subtitulo1 = "Alta Operador ER";
%>
                   ...
                   String sql="";
                           ...
                           try{
                            ...
                            con.setAutoCommit(false);
                             ...
                             sql="Insert into operador (codigo, descripcion, licencia, comunidad) values('"+ Codigo + "','" + Descripcion + "','" + Licencia + "','" + Comunidad + "')";

                             Resultado=stm.executeUpdate(sql);

                             if (Resultado > 0 ) {
                                 con.commit();
                                 mensaje ="EL OPERADOR HA SIDO DADO DE ALTA";
                                 }
                             else
                               {
                        ...
                        mensaje="Exception al insertar Operador: " + e;
                   }finally {
                        try {
                                if (rs != null){
                                        rs.close();
