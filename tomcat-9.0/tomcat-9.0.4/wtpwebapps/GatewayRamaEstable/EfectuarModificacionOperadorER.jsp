...
<%@ page import="java.sql.*" %>
 <% 
	  ...
	  String subtitulo1 = "Modificar Operador ER";
          ...
          <TR>
            ...
            <TD class=Titulo vAlign=top align=middle background="images/fondocentro.gif">
               ...
               <DIV align=left class="Titulo">&nbsp;&nbsp;&nbsp;<img src="images/flecha.gif" border="0"/>Alta operador ER</DIV>
                     ...
                     <%
                       String sql="";
                               ...
                               try{
                                 ...
                                 sql="update  operador set descripcion = '" + Descripcion + "',licencia ='" + Licencia + "',comunidad='" + Comunidad + "' where codigo='"+ Codigo + "'";

                                 Resultado=stm.executeUpdate(sql);

                                 if (Resultado > 0 ) {
                                     con.commit();
                                     mensaje ="EL OPERADOR HA SIDO ACTUALIZADO";
                                     }
                                 else
                                   {
                            ...
                            mensaje="Exception al actualizar Operador: " + e;
                       }finally {
                            try {
                                    if (rs != null){
                                            rs.close();
                    ...
                    <br><br>
                    <CENTER>
                     <a href="javascript:void(document.formu.submit())//'" onMouseOver="window.status='Aceptar';return true" onMouseOut="window.status=' '"><img src="images/Aceptar.jpg" width="107" height="28" border="0" alt="Modificacion operador ER"></a>
                    </CENTER>
