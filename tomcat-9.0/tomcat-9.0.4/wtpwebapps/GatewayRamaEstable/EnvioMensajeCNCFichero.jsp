...
<%@ page import="java.io.*"%>
  <%
    ...
    String subtitulo1=new String("Carga fichero cancelaci&oacute;n de cambio");
	String remitente = (String) request.getAttribute("OperadorConectado");
	String rol = request.getParameter("jsp");
	String anterior;
	if (rol.equals("Receptor")) {
		anterior = "MenuRolReceptor.jsp";
	} else {
		anterior = "MenuRolDonante.jsp";
	}
        ...
        <TR>
          ...
          <TD class=Titulo vAlign=top align=middle background="images/fondocentro.gif">
             ...
             <DIV align=left class="Titulo">&nbsp;&nbsp;&nbsp;<img src="images/flecha.gif" border="0"/>
             	Carga fichero <%=tipoMDescripcion%>
                                ...
                                <td align="center" colspan="3">
                                    <table width="100%">
                                        <tr>
                                          ...
                                          <td align="center">
											<form action="CancelacionesPendientes" name="verPendientes" method="post">
                    							<INPUT TYPE="hidden" name="Rol" value="<%= rol %>"/>
                                        	</form>
                                          <a href="javascript:document.verPendientes.submit();//'" >
                                          	<font class="texto2">Ver cancelaciones pendientes</font></a>
                                          </td>
                                        </tr>
                                    </table>
                            </tr>
                            <tr>
                                <td align="center">
                                  <form action="UploadFichero" name="subeFichero" method="post" enctype='multipart/form-data'>
                    					<INPUT TYPE="hidden" name="tipoMensaje" value="CNC">
