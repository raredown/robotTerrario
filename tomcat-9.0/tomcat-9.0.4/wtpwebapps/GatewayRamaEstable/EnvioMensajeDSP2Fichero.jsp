...
<%@ page import="java.io.*"%>
  <%
	...
	String tipoMDescripcion = sing.getTipoMDescripcion("DSP2");
	
    String subtitulo1=new String("Carga fichero denegaciones");
                            ...
                            <tr>
                                <td align="center">
                                  <form action="UploadFichero" name="subeFichero" method="post" enctype='multipart/form-data'>
                    					<INPUT TYPE="hidden" name="tipoMensaje" value="DSP2">
