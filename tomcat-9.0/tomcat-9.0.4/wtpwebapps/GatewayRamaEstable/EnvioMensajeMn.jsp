...
<%@ page import="java.io.*"%>
  <%
	...
	String tipoMDescripcion = sing.getTipoMDescripcion("MN"); 
                ...
                <table width="95%" border="0" cellspacing="5">
                   ...
                   <TR>
                    ...
                    <tr>
                      ...
                      <TD colspan="3"><input type="text" class="inputText" class="inputText" size="70" maxlength="80" name="T2"></TD>
                    </tr>
                    <tr>
                      <TD><font class="texto2">N&uacute;mero inicial del rango: </font></TD>
                      <TD colspan="1"><input type="text" class="inputText" class="inputText" size="15" maxlength="15" name="Rango1"></TD>
                      <TD><font class="texto2">N&uacute;mero final del rango: </font></TD>
                      <TD colspan="1"><input type="text" class="inputText" class="inputText" size="15" maxlength="15" name="Rango2"></TD>
                    </tr>
                    <tr>
                      <TD><font class="texto2">Fecha inicio ventana: </font></TD>
                      <TD><input type="text" class="inputText" class="inputText" size="10" maxlength="10" name="Fecha" readonly>
