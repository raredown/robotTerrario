...
<%@ page import="java.io.*"%>
  <%
    ...
    String subtitulo1=new String("Carga fichero cambio de operador");
                                ...
                                <td align="center" colspan="3">
                                    <table width="100%">
                                        <tr>
                                          ...
                                          <td align="center"><a href="SolicitudesPendientes" ><font class="texto2">Ver solicitudes pendientes</font></a></td>
                                        </tr>
                                    </table>
                            </tr>
                            <tr>
                                <td align="center">
                                  <form action="UploadFichero" name="subeFichero" method="post" enctype='multipart/form-data'>
                    					<INPUT TYPE="hidden" name="tipoMensaje" value="SP">
