...
function Navegar(nPagina){
       ...
       f.action="PrevioMantenimientoMultiplesNRN";
       f.submit();
}
...
<%@ page import="java.io.*"%>
  <%
      ...
      if(colnrn!=null)
       {
           vnrn = colnrn.getNRNs(inici,Limite);
           numnrn = colnrn.getNumeroNRNs();
       }else{
         vnrn=null;
         numnrn=0;
       }
        ...
        <TR>
          ...
          <TD class=Titulo vAlign=top align=middle background="images/fondocentro.gif">
             ...
             <DIV align=left class="Titulo">&nbsp;&nbsp;&nbsp;<img src="images/flecha.gif" border="0"/>Lista NRN</DIV>
                ...
                <%System.out.println("Estamos en el jsp MantenenimientoMultiplesNRN");%>
                ...
                <P>
                <HR>
                <h5 align="left">&nbsp;&nbsp;&nbsp;<img src="images/flecha.gif" border="0"/>Rango de NRNs</h5>
                <table border="0">
                <tr>
                ...
                <td><a href="javascript:TodoOk(1)//'" onMouseOver="window.status='Alta';return true;" onMouseOver="window.status=' '"><img src="images/Manten1.jpg" border="0" WIDTH="107" HEIGHT="28"></a></td>
                <td><a href="javascript:TodoOk(2)//'" onMouseOver="window.status='Modificación';return true;" onMouseOver="window.status=' '"><img src="images/Manten2.jpg" border="0" WIDTH="107" HEIGHT="28"></a></td>
                <td><a href="javascript:TodoOk(3)//'" onMouseOver="window.status='Baja';return true;" onMouseOver="window.status=' '"><img src="images/Manten3.jpg" border="0" WIDTH="107" HEIGHT="28"></a></td>
                </tr>
                </table>
                <P>
                <HR>
