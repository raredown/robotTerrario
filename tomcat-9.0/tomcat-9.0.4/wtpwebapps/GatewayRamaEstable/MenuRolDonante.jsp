       ...
       /*     if ( fHoy.esFestivo())
             {
                ...
                try{
                    ...
                    System.err.println("MenuRolDonante.java Excepcion en Servlet -->"+e);
                }catch(IOException e){
                    System.err.println("MenuRolDonante.java Excepcion en Servlet -->"+e);
                }
...
<script language="JavaScript">
  ...
  <TR>
    ...
    <TD class=Titulo vAlign=top align=middle background="images/fondocentro.gif">
       <br>
       <DIV align="left" class="Titulo">&nbsp;&nbsp;&nbsp;<img src="images/flecha.gif" border="0"/>Rol de Donante&nbsp;&nbsp;</DIV>
          <br>
          <br>
          <center>
          <table align="left" border="0" cellpadding="0" cellspacing="2" width="95%">
          <logic:iterate id="link" name="linksDonante" type="es.gateway.sesiones.permisos.bean.LinkBean" indexId="ij" scope="request">
           ...
           <FORM METHOD=POST ID="theForm<c:out value="${ij}"/>" NAME="theForm<c:out value="${ij}"/>">
                ...
                <INPUT TYPE="hidden" NAME="origen" VALUE="MenuRolDonante.jsp">
                <INPUT TYPE="hidden" NAME="opcionMenu" VALUE="<bean:write property="metodo" name="link" />">
             <tr>
                <td width="10%"></td>
