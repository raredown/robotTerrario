                ...
                <% String proceso=IdProceso;
                 ...
                 %>
                   <form action="EnviarMsgCNC" method="POST" name="theForm" >
                    ...
                    <table border="0" cellspacing="5">
                        ...
                        <tr>
                            <td colspan="6">
                                ...
                                <input type="text" class="inputText" class="inputText" size="65" maxlength="80" name="Observaciones" value="<c:out value="${mensajeCNC.observaciones}"/>">
                            </td>
                        </tr>
                    ...
                    %>
                            <option <%=des.seleccionado%> value="<%= des.valor%>" <%if (mensajeCNC.getCodCausaCancelacion().equals(des.valor)){ %>selected<%} %>><%=des.nombre%></option>			<%
                        }
                    %>
                        </SELECT>
                            </font>
