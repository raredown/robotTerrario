                    ...
                    <table border="0" cellspacing="5">
                        ...
                        <tr>
                            <td colspan="6">
                                ...
                                <input type="text" class="inputText" class="inputText" size="65" maxlength="80" name="Observaciones" value="<c:out value="${mensajeCNM.observaciones}"/>">
                            </td>
                        </tr>
                        <tr>
                            <td colspan="6">
                                <font class="texto2">Número identificaci&oacute;n&nbsp;proceso:&nbsp;</font>
                                <font class="texto"><c:out value="${mensajeCNM.idProceso}"/></font>
                                <INPUT TYPE="hidden" name="IdProceso" value="<c:out value="${mensajeCNM.idProceso}"/>">&nbsp;&nbsp;
                            </td>
                        </tr>
                        <tr>
                            <td colspan="6">
