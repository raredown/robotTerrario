...
<%@ page import="java.util.Vector,
                 ...
                 es.portanode.mensajes.MensajeDIN"%>
<%@ page import="java.io.*"%>
  ...
  <%
	...
	MensajeDIN mensajeDIN = (MensajeDIN) request.getAttribute("mensajeDIN");
      ...
      document.write(tabla);
        ...
        <TR>
          ...
          <TD class=Titulo vAlign=top align=middle background="images/fondocentro.gif">
             <br>
             <DIV align=left class="Titulo">&nbsp;&nbsp;&nbsp;<img src="images/flecha.gif" border="0"/>Envia DIN</DIV>
                ...
                <table border="0" cellspacing="5">
                    ...
                    <tr>
                      ...
                      <TD colspan="3"><input type="text" class="inputText" class="inputText" size="70" maxlength="80" name="Observaciones" value ="<c:out value="${mensajeDIN.observaciones }"/>"></TD>
                    </tr>
                    <tr>
                      <TD><font class="texto2">N&uacute;mero inicial del rango: </font></TD>
                      <TD><input type="text" class="inputText" class="inputText" size="15" maxlength="15" name="Rango1" value ="<c:out value="${mensajeDIN.numInicialRango }"/>"></TD>
                      <TD><font class="texto2">N&uacute;mero final del rango: </font></TD>
                            <TD><input type="text" class="inputText" class="inputText" size="15" maxlength="15" name="Rango2" value ="<c:out value="${mensajeDIN.numFinalRango }"/>"></TD>
                    </tr>
                    <tr>
                      <TD><font class="texto2">NRN:</font></TD><TD><input type="text" class="inputText" class="inputText" size="6" maxlength="6" name="NRN" value ="<c:out value="${mensajeDIN.NRN }"/>"></TD>
                    </tr>
                    <tr>
                    ...
                    %>
                            <option value="<%=op.getCodigo()%>" <%if (op.getCodigo().equals(mensajeDIN.getOperadorCausante())){ %>selected<% }%>><%=op.getDescripcion()%>-<%=op.getCodigo()%></option>				<%
                            }
                        }
                    %>
