      ...
      document.write(tabla);
        ...
        <TR>
          ...
          <TD class=Titulo vAlign=top align=middle background="images/fondocentro.gif">
             <br>
             <DIV align=left class="Titulo">&nbsp;&nbsp;&nbsp;<img src="images/flecha.gif" border="0"/>Envia NB</DIV>
				...
				<input type="hidden" name="idProcesoMensajeErroneo" value="<c:out value="${idProcesoMensajeErroneo }"/>">
                    <div align="center"><center><table width="100%" border="0" cellspacing="5">
                        ...
                        <tr>
							...
							<c:forEach items="${vops}" var="oper">
							<c:if test="${oper.codigo ne '00000'}">
								<option value="<c:out value="${oper.codigo}"/>" <c:if test="${oper.codigo eq mensajeNB.opDonanteInicial }">selected</c:if>><c:out value="${oper.descripcion}"/>-<c:out value="${oper.codigo}"/></option>
							</c:if>
							</c:forEach> 
							</select></td>
                        ...
                        <tr>
                            ...
                            <td colspan="3"><input type="text" class="inputText" class="inputText" size="65" maxlength="80" name="Observaciones" value="<c:out value="${mensajeNB.observaciones }"/>"></td>
                        </tr>
                        <tr>
                            <td ><font class="texto2">N&uacute;mero inicial del rango </font></td>
                            <td><input type="text" class="inputText" class="inputText" size="15" maxlength="15" name="Rango1" value="<c:out value="${mensajeNB.numInicialRango }"/>"></td>
                            <td ><font class="texto2">N&uacute;mero final del rango </font></td>
                            <td><input type="text" class="inputText" class="inputText" size="15" maxlength="15" name="Rango2" value="<c:out value="${mensajeNB.numFinalRango }"/>"></td>
                        </tr>
                    </table>
                <BR>
