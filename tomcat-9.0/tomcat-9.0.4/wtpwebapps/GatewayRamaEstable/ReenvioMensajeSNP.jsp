                ...
                <form action="EnviarMsgSNP" method=POST name="theForm">
					...
					<div align="center"><center><table border="0" cellspacing="5">
                        ...
                        <tr>
                         ...
                         <td colspan="3"><input type="text" class="inputText" class="inputText" size="50" maxlength="80" name="Observaciones" value="<c:out value="${mensajeSNP.observaciones }"/>"></td>
                        </tr>
                        <tr>
                            <td><font class="texto2">Tipo de adquisici&oacute;n:&nbsp;</font></td>
                         <td><INPUT type="radio" name="radio" value="0" <c:if test="${mensajeSNP.tipoAdquisicion eq '0' }">checked</c:if>><font class="texto2">Total</font></td>
                            <td></td>
                         <td>
                      </td>
                        </tr>
                        <tr>
                            <td></td>
                         <td><INPUT type="radio" name="radio" value="1" <c:if test="${mensajeSNP.tipoAdquisicion eq '1' }">checked</c:if>><font class="texto2"> Por fechas</font></td>
                            <td><font class="texto2"> Fecha inicial:</font></td>
                         <td><input type="text" class="inputText" class="inputText" ReadOnly size="10" maxlength="10" name="FechaInicial" <c:if test="${mensajeSNP.tipoAdquisicion eq '1' }">value="<c:out value="${fechaInicial}"/>"</c:if>>
                        ...
                        <tr>
                         ...
                         <td><input type="text" class="inputText" class="inputText" ReadOnly size="10" maxlength="10" name="FechaFinal" <c:if test="${mensajeSNP.tipoAdquisicion eq '1' }">value="<c:out value="${fechaFinal}"/>"</c:if>>
                             <a href="javascript:calendario2.popup();"><img src="images/calendar/cal.gif" width="16" height="16" border="0" alt="Calendario"></a>
                         </td>
                        </tr>
                        <tr>
                            <td></td>
                         <td><INPUT type="radio" name="radio" value="2" <c:if test="${mensajeSNP.tipoAdquisicion eq '2' }">checked</c:if>><font class="texto2"> Por n&uacute;meros</font></td>
                            <td><font class="texto2"> N&uacute;mero inicial:</font></td>
                         <td><input type="text" class="inputText" class="inputText" size="15" maxlength="15" name="Rango1" <c:if test="${mensajeSNP.tipoAdquisicion eq '2' }">value="<c:out value="${mensajeSNP.numInicialRango}"/>"</c:if>></td>
                        </tr>
                        <tr>
                            <td></td>
                         <td></td>
                            <td><font class="texto2"> N&uacute;mero final:</font></td>
                         <td><input type="text" class="inputText" class="inputText" size="15" maxlength="15" name="Rango2" <c:if test="${mensajeSNP.tipoAdquisicion eq '2' }">value="<c:out value="${mensajeSNP.numFinalRango}"/>"</c:if>></td>
                        </tr>
                        </table>
                <BR>
