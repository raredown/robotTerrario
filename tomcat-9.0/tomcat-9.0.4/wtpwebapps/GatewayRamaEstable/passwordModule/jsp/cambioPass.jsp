...
document.write(tabla);
  ...
  <TR>
    ...
    <TD vAlign=top width="180" class="celdalineaderecha">
      <jsp:include page="/passwordModule/jsp/include/menu_vacio.jsp" flush="true"/>
        ...
        <center>
          <form action="CambioPassword" method="post" name="theForm">
            <table border="0" width="90%">
                <tr>
                    <td colspan="2" align="center"><p><font class="texto2" color="red"><b><%=mensaje%>&nbsp;</b></font></p></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td align="left"><input type="password" class="inputText" name="pass" onKeyUp="detectarEnter(this)" maxlength="10"></td>
                </tr>
                 <tr>
                    <td align="right"><b><font class="texto2"><fmt:message key="texto.cambiarpassword.contrasenia_nueva"/>: </font></b></td>
                    <td align="left"><input type="password" class="inputText" name="newpass" onKeyUp="detectarEnter(this)" maxlength="10"></td>
                </tr>
                 <tr>
                    <td align="right"><b><font class="texto2"><fmt:message key="texto.cambiarpassword.confirm_contrasenia_nueva"/>: </font></b></td>
                    <td align="left"><input type="password" class="inputText" name="newpass2" onKeyUp="detectarEnter(this)" maxlength="10"></td>
                </tr>
                <tr>
